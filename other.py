...
b = torch.tensor([[[0,1,2,3,4,0], [1,1,1,3,4,2], [1,2,2,3,4,2], [1,1,2,3,4,3], [0,1,2,4,4,0]],
                  [[0,1,2,3,4,4], [1,2,1,3,4,2], [1,2,2,3,4,1], [1,1,2,3,4,1], [0,1,2,4,4,4]],
                  [[0,1,2,3,4,2], [1,3,1,3,4,2], [1,2,2,3,4,3], [1,1,2,3,4,2], [0,1,2,4,4,1]]])
print(b)
d = padding_3d(b, 4, 6, 9)
print(d)
